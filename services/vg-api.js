...
var VgAPI = (function () {
    ...
    VgAPI.prototype.toggleFullscreen = function (element) {
        ...
        if (api_1.VgFullscreenAPI.isFullscreen()) {
            api_1.VgFullscreenAPI.exit();
        }
        else {
            api_1.VgFullscreenAPI.request(element);
        }
    };
    VgAPI.prototype.isFullscreen = function () {
        return api_1.VgFullscreenAPI.isFullscreen();
    };
    VgAPI.prototype.connect = function (media) {
        media.addEventListener(api_1.VgEvents.VG_CAN_PLAY, this.onCanPlay.bind(this, media.id), false);
        media.addEventListener(api_1.VgEvents.VG_CAN_PLAY_THROUGH, this.onCanPlayThrough.bind(this, media.id), false);
        media.addEventListener(api_1.VgEvents.VG_LOADED_METADATA, this.onLoadMetadata.bind(this, media.id), false);
        media.addEventListener(api_1.VgEvents.VG_WAITING, this.onWait.bind(this, media.id), false);
        media.addEventListener(api_1.VgEvents.VG_PROGRESS, this.onProgress.bind(this, media.id), false);
        media.addEventListener(api_1.VgEvents.VG_ENDED, this.onComplete.bind(this, media.id), false);
        media.addEventListener(api_1.VgEvents.VG_PLAYING, this.onStartPlaying.bind(this, media.id), false);
        media.addEventListener(api_1.VgEvents.VG_PLAY, this.onPlay.bind(this, media.id), false);
        media.addEventListener(api_1.VgEvents.VG_PAUSE, this.onPause.bind(this, media.id), false);
        media.addEventListener(api_1.VgEvents.VG_PLAYBACK_CHANGE, this.onPlaybackChange.bind(this, media.id), false);
        media.addEventListener(api_1.VgEvents.VG_TIME_UPDATE, this.onTimeUpdate.bind(this, media.id), false);
        media.addEventListener(api_1.VgEvents.VG_VOLUME_CHANGE, this.onVolumeChange.bind(this, media.id), false);
        media.addEventListener(api_1.VgEvents.VG_ERROR, this.onError.bind(this, media.id), false);
    };
